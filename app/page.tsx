  ...
  const eventItems = [
    {
      ...
      description:
        "Vi starter kvelden samlet – med bobler, latter og adresser.",
      ...
      <main className="max-w-4xl mx-auto px-4 my-24 text-gray-800">
        <header className="flex items-center mb-12 text-center">
          ...
          <div className="text-start">
            ...
            <p className="text-lg">En smaksrik kveld i hjertet av Bergen!</p>
          </div>
        </header>
        ...
        <section aria-labelledby="intro-heading" className="mb-12">
          ...
          <p className="mb-2">
            Tour de Møhlenpris er mer enn en middag – det er en opplevelse! Tre
            retter. Tre hjem. En uforglemmelig kveld.
          </p>
          <p>
            Enten du er ny i nabolaget eller en erfaren Møhlenprisar – dette er
            din sjanse til å møte nye mennesker, smake på fantastisk mat og være
            en del av et varmt og inkluderende fellesskap.
          </p>
        </section>

        <section
          aria-labelledby="how-heading"
          className="flex flex-col items-center mb-18 mt-12"
        >
          <h2 id="how-heading" className="text-2xl font-semibold mb-10 w-full">
            Slik fungerer det
          </h2>
        ...
        <section aria-labelledby="participate-heading" className="mb-12">
          <h2 id="participate-heading" className="text-2xl font-semibold mb-6">
            Vil du være med?
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <article className="bg-gray-100 p-6 rounded-lg shadow">
              ...
              <p className="mb-4">
                Alt du trenger? Et åpent sinn og et tomt vinglass!
              </p>
            ...
            <article className="bg-gray-100 p-6 rounded-lg shadow">
              ...
              <p className="mb-2">
                Åpne hjemmet ditt for forrett, hovedrett eller dessert. Du får:
              </p>
        ...
        <section aria-labelledby="signup-heading" className="">
          ...
          <p className="mb-2 text-lg font-medium">
            📝{" "}
            <Link
              href="https://www.letsreg.com/no/event/tour_de_mohlenpris_30032019#init"
              className="text-blue-600 underline"
            >
